...
Webauthn support enables Teleport users to use modern second factor devices -
apple watch, touch ID.

Second factor management user interface enables users to update and manage their
second factor devices in the browsers. Our UI becomes more secure by requiring
users performing some privileged actions, for example editing roles for a second
factor confirmation.
